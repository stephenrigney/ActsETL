...
| `section` | `body`, `part`, `chapter` | `eId` (e.g., "sec_1") | Section - primary unit of law |
| `subsection` | `section` | `eId` (e.g., "sec_1__subsec_1") | Subsection within a section |
...
| Section | `sec_{number}` | `sec_1`, `sec_118` |
| Subsection | `sec_{n}__subsec_{m}` | `sec_1__subsec_1` |
| Paragraph | `sec_{n}__subsec_{m}__para_{letter}` | `sec_1__subsec_1__para_a` |
| Subparagraph | `...__para_{l}__subpara_{roman}` | `sec_1__subsec_1__para_a__subpara_i` |
